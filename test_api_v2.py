...
from new_code.processing_v8 import calculate_glare
...
def runScriptLocally(data: GlareRequestModel):
    ...
    simulation_parameter = {'grid_width': data.simulation_parameter.grid_width,
                            ...
                            'intensity_threshold': data.simulation_parameter.intensity_threshold,
                            'module_type': data.simulation_parameter.module_type,
    ...
    calculate_glare(pv_areas,
                    ...
                    google_api_key,path,data.excluded_areas)
